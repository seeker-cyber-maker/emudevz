...
import { ParseError, ParseLine } from "@neshacker/6502-tools/src/parser/index.js";
...
function createAsmContext(level, filesystem) {
	...
	const preCode = preCodeFile == null ? null : readLevelCode(level, preCodeFile);
