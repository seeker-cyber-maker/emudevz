...
- `PPU::_onPreLine()` debería restablecer las banderas de `PPUStatus` incluso si el renderizado está desactivado. Esto puede corregir un problema de parpadeo de pantalla en algunos juegos.
